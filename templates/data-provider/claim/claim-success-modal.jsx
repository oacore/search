    ...
    {isDataProviderHasAccounts ? (
      <>
        ...
        <Modal.Content tag="div" className={styles.successModalContent}>
          ...
          <p>
            You request sent to the repository manager. Your eligibility to
            claim the repository will be checked and you will be contacted at
      ...
      <>
        <Modal.Title>
          {newEmail ? 'Claim CORE Dashboard' : 'Claim Repository Dashboard'}
        </Modal.Title>
        <Modal.Content tag="div" className={styles.successModalContent}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            className={
              newEmail
                ? styles.successImageInvitation
                : styles.successImageCheck
            }
          >
            <image
          ...
          {newEmail ? (
            ...
            <p>
              ...
              <b>{contactData.email}</b>. Please, check your inbox and follow
